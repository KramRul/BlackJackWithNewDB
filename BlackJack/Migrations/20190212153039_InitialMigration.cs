    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Suite = table.Column<byte>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerSteps_AspNetUsers_PlayerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealerSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealerSteps_Dealers_DealerId",
                        column: x => x.DealerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dealers_GameId",
                table: "Dealers",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerSteps_DealerId",
                table: "DealerSteps",
                column: "DealerId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerSteps_PlayerId1",
                table: "PlayerSteps",
                column: "PlayerId1");
        }
